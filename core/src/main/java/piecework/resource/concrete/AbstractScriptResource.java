...
public abstract class AbstractScriptResource {
    ...
    protected Form form(final Process process, final MessageContext context, final Entity principal) throws NotFoundError {
        try {
            ...
            Form form = formFactory.form(process, deployment, request, ActionType.CREATE, principal, MediaType.TEXT_HTML_TYPE, null, null, includeRestrictedData, isAnonymous());
            return form;
