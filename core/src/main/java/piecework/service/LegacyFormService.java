 ...
 */
@Deprecated
public class LegacyFormService {

//    private static final Logger LOG = Logger.getLogger(LegacyFormService.class);
//
//    @Autowired
...
//
//        return legacyFormFactory.form(formRequest, process, formRequest.getInstance(), formRequest.getTask(), null, actionType, principal);
//    }
//
