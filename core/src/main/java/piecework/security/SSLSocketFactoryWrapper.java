/**
 * This code is copied from Apache CXF org.apache.cxf.transport.https.SSLSocketFactoryWrapper
 * to be used in compliance with the following license. It was necessary to copy the file over
 * since the CXF developers seem to have intended to use it locally and did not make this class public. 
 * 
 * 
