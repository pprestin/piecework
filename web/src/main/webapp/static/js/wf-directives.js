            ...
            function(dialogs, instanceService, notificationService, taskService, wizardService) {
                return {
                    ...
                    template:
                        ...
                        '   <button data-ng-click="dialogs.openRestartModal(getFormsSelected([\'Open\',\'Cancelled\',\'Complete\']))" data-ng-show="isFormSelected([\'Open\',\'Cancelled\',\'Complete\'])" class="btn btn-default navbar-btn" title="Restart process" type="button"><i class="fa fa-rotate-left"></i></button>\n' +
