...
public class ClientConfiguration {
    ...
    @Bean
    public KeyManagerCabinet keyManagerCabinet(Environment environment) throws Exception {
    ...
    private KeyManagerCabinet keyManagerCabinet(SecuritySettings securitySettings) throws Exception {
